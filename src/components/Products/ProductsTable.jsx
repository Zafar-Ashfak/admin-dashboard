...
import Image1 from "../../assets/earbud.png";
import Image2 from "../../assets/wallet.png";
import Image3 from "../../assets/smartwatch.png";
import Image4 from "../../assets/yoga-mat.png";
import Image5 from "../../assets/bread-toster.png";
const productsData = [
  { 
    id: 1,
    img: Image1,
  ...
  return (
    <motion.div
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:justify-between items-center mb-6">
        <h2 className="text-xl font-medium text-gray-100">Product List</h2>
          ...
          <tbody className="divide-y divide-gray-700">
            {filteredProducts.map((product) => (
              <motion.tr
                ...
                <td className="px-6 py-4 text-sm font-bold text-gray-100 flex gap-2 items-center">
                  <img
                    src={product.img}
                    alt="Product Image"
