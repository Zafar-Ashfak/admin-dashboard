...
const overviewData = [
  { name: "Revenue", value: "$2,312,576", change: 12.5, icon: DollarSign },
  { name: "Users", value: "45,214", change: 8.3, icon: Users },
  { name: "Orders", value: "9,847", change: -3.2, icon: ShoppingBag },
  { name: "Page Views", value: "2,148,313", change: 15.7, icon: Eye },
];
