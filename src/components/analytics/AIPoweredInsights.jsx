...
const INSIGHTS = [
  {
    ...
    insight:
      "Revenue is up 15% compared to last month, driven primarily by a successful email compaign.",
  },
  {
    icon: Users,
    color: "text-blue-500",
  ...
  },
  {
    ...
    insight:
      "Optimize pricing strategy could potentially increase overall profit margins by 5.7%.",
  },
];
